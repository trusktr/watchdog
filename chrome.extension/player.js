...
window.onunload = function() {
	backgroundPage.playerWindowUnloadNotification();
	return true;
};
...
function setLayout(layoutObj) {
	...
	for (var i=0; i<layoutObj.partitions.length; i++) {
		var partition = layoutObj.partitions[i],
...
$(document).ready(function() {
	...
	backgroundPage.playerWindowReadyNotification(window);
